...
if (!groqApiKey) {
  console.error("Error: GROQ_API_KEY is not set. Create backend/.env with GROQ_API_KEY=your_groq_api_key_here");
  process.exit(1);
}
